    ...
    private void openFile(final File file) {
        if (file.getName().matches(".*\\.fasta")) {
            ...
            try {
                ...
                final TextFlow trackName = new TextFlow(new Text(file.getName()));
                ...
                final TextFlow trackContent = new TextFlow(new Text(new String(new FastaFileReference(fasta).contigs().get("1").getBytes(1000000, 100))));
