package jbwt.algorithm.SAIS;

import jbwt.base.Text;
import jbwt.sa.SuffixArray;
 ...
 */
//public class SAIS<S> implements Function<Text<S>, SuffixArray> {
//
//    /* find the start or end of each bucket */
//    private long[] getCounts(final Text<S> T, final Text<S> C, int n, int k) {
//        int i;
